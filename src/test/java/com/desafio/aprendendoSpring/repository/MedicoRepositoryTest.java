...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico medico cadastrado não estvier disponivel na data")
    void escolherMedicoAleatorioLivreNaData() {


       var proximaSgundaAsDez = LocalDateTime.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY)).withHour(10).withMinute(0);
       var medico = cadastrarMedico("Medico", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
       var paciente = cadastrarPaciente("Paciente", "paciente@email.com", "00000000000");
         cadastrarConsulta(medico, paciente, proximaSgundaAsDez);

       var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSgundaAsDez);
